...
export default function AboutUs() {
    return (
        <>
            <div id='AboutUs' className='flex flex-col justify-center items-center w-full h-auto px-1 py-6 sm:py-10 sm:px-7 bg-gradient-to-b from-[#73737d] to-violet-500'>
